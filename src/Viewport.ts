...
import { PLYFileTypeHandler } from "./PLYFiletypeHandler";
import { ObjFileTypeHandler } from "./ObjFileTypeHandler";
import { ThreeJSFileTypeHandler } from "./ThreeJSFileTypeHandler";
import { glTFFileTypeHandler } from "./glTFFileTypeHandler";
import { CORTOFileTypeHandler } from "./CORTOFileTypeHandler";
import { DRACOFileTypeHandler } from "./DRACOFileTypeHandler";
import { IVirtexData, IVirtexOptions } from "./IVirtexData";
...
export class Viewport {
    ...
    private _mousePos: Vector2 = new THREE.Vector2();
    private _mousePosNorm: Vector2 = new THREE.Vector2(-1, -1);
    private _mousePosOnMouseDown: Vector2 = new THREE.Vector2();
    private _oldie: HTMLElement;
    private _pinchStart: Vector2 = new THREE.Vector2();
    ...
    private _stats: any;
    private _targetRotation: Vector2 = new THREE.Vector2();
    private _targetRotationOnMouseDown: Vector2 = new THREE.Vector2();
    private _targetZoom: number;
    private _viewport: HTMLElement;
    private _viewportCenter: Vector2 = new THREE.Vector2();
    ...
    private _onTouchMove(event: TouchEvent): void {
        ...
        switch (touches.length) {
            ...
            case 2: // two-fingered touch: zoom
                ...
                const pinchEnd: Vector2 = new THREE.Vector2(0, distance);
                const pinchDelta: Vector2 = new THREE.Vector2();
