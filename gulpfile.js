...
tasks.init({
    ...
    libs: [
        ...
        'node_modules/three/examples/js/loaders/draco/draco_decoder.js',
        'node_modules/three/examples/js/loaders/draco/DRACOLoader.js',
        'node_modules/three/examples/js/loaders/corto/corto.js',
        'node_modules/three/examples/js/loaders/corto/CORTOLoader.js',
